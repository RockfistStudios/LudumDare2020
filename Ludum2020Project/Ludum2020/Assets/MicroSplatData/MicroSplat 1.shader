...
{
   #if !_MICROMESH && !_MICROMESHTERRAIN && !_MICROPOLARISMESH && !_MICRODIGGERMESH && !_MICROVERTEXMESH
    ...
    MicroSplatLayer DoMicroSplat(inout SurfaceDescriptionInputs IN)
    {
       ...
       float3 worldNormalVertex = IN.WorldSpaceNormal;
        ...
        #if defined(UNITY_INSTANCING_ENABLED) && !_MICROMESH && !_MICROMESHTERRAIN && !_MICROPOLARISMESH && !_MICRODIGGERMESH && !_MICROVERTEXMESH && !PASSSHADOW
...
GraphVertexInput ApplyMeshModification(inout GraphVertexInput input)
{
   ...
   Dependency "BaseMapShader" = "Hidden/MicroSplat/Terrain_Base1250523296"
